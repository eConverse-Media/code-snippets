        ...
        constructor() {
            ...
            function success(resp) {
                for (var i = 0; i < resp.length; i++) {
                    ...
                    $(currentElem).append('<h3><a href="' + resp[i].LinkToMessage + '">' + resp[i].DiscussionName + '</a></h3><h5><strong>By: </strong><a href=" ' + resp[i].Author.LinkToProfile + '">' + resp[i].Author.FirstName + ' ' + resp[i].Author.LastName + '</a></h5><h5><strong>Date:</strong> ' + resp[i].DatePosted + '</h5><div>' + resp[i].Body + '</div>');
                }
            }
